    ...
    <div className="min-h-screen lg:grid lg:grid-cols-2">
      ...
      <main className="flex min-h-screen flex-col justify-center px-6 py-12 lg:min-h-0 lg:px-12">
        <div className="mx-auto w-full max-w-sm">
          <Link href="/" className="mb-10 flex items-center gap-2.5 text-sm font-semibold">
      ...
      <aside className="hidden border-l border-border bg-subtle lg:flex lg:flex-col lg:justify-center lg:px-12">
          ...
          <ul className="mt-8 space-y-4">
            {HIGHLIGHTS.map((item) => (
              <li key={item.text} className="flex items-center gap-3 text-sm">
                <span
                  aria-hidden="true"
                  className="flex size-8 shrink-0 items-center justify-center rounded-md border border-border bg-card text-muted-foreground"
                >
